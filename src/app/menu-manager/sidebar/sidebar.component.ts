...
export class SidebarComponent {
  ...
  items: any[] = [
    ...
    },
    {
      label: 'Réparations',
      icon: 'pi pi-wrench',
      items: [ { label: 'Gestion des marques', command: () => { this.router.navigate(['/marques']); }},
                { label: 'Gestion des propos', command: () => { this.router.navigate(['/propos']) }},
                { label: 'Gestion des prestations', command: () => { this.router.navigate(['/prestations']) }},
                { label: 'Gestion des promotions', command: () => { this.router.navigate(['/promotions']) }},
